...
<?php
    ...
    ?>
    <img src="img/close-up-hands-hackers-hacking-steal-important-information-use-computer-release-malware-viruses-ransom-harass-organizations-he-sitting-dark-room-with-neon-light.jpg"
        class="bg1">
    ...
    <img src="img/6.png" class="img3">
    <div class="card1_"></div>
    <div class="h1">Cross - Site Scripting</div>
    <div class="bh2"></div>
    <div class="h2">7 Sections</div>
    <div class="h3"><span><b>สวัสดีครับทุกท่านน !!</b> ขอต้อนรับเข้าสู่ <b>Lab</b> ของ <b> Cross - Site Scripting</b> นะครับ</span>
    </div>
    ...
    <img src="img/hand-man-using-laptop-computer-dark.jpg" class="bg2">
    ...
    <div class="mm1"><span>เอกสารอธิบายการทำแลป <span style="color: #A6CF98;">Cross - Site Scripting</span></span></div>
    <!-- PDF DOWNLOAD 
    ...
    <div class="mm2"><span>Coming soon</span></div>
