...
<body>
    ...
    ?>
    <img src="img/anonymous-hacker-uses-malware-with-mobile-phone-hack-password-personal-data-money-from-bank-accounts-concept-cyber-crime.jpg"
        class="bg1">
    ...
    <img src="img/7.png" class="img3">
    <div class="card1_"></div>
    <div class="h1">SQL Injection</div>
    <div class="bh2"></div>
    <div class="h2">5 Sections</div>
    <div class="h3"><span><b>สวัสดีครับทุกท่านน !!</b> ขอต้อนรับเข้าสู่ <b>Lab</b> ของ <b> SQL Injection</b> นะครับ</span>
    </div>
    ...
    <a href="../SQLInjection/Level/0/" onmouseover="onHover('sectionCard1')" onmouseout="outHover('sectionCard1')">
        <div class="s0">0</div>
        <div class="t0">เนื้อหาบทนี้<br><span style="color: white; font-size: 16px;">Section 0</span></div>
    </a>
    <a href="../SQLInjection/Level/0/" onmouseover="onHover('sectionCard2')" onmouseout="outHover('sectionCard2')">
        <div class="s1">1</div>
        <div class="t1">LEVEL ONE<br><span style="color: white; font-size: 16px;">Section 1</span></div>
    </a>
    <a href="../SQLInjection/Level/0/" onmouseover="onHover('sectionCard3')" onmouseout="outHover('sectionCard3')">
        <div class="s2">2</div>
        <div class="t2">LEVEL TWO<br><span style="color: white; font-size: 16px;">Section 2</span></div>
    </a>
    <a href="../SQLInjection/Level/0/" onmouseover="onHover('sectionCard4')" onmouseout="outHover('sectionCard4')">
        <div class="s3">3</div>
        <div class="t3">LEVEL THREE<br><span style="color: white; font-size: 16px;">Section 3</span></div>
    </a>
    <a href="../SQLInjection/Level/0/" onmouseover="onHover('sectionCard5')" onmouseout="outHover('sectionCard5')">
        <div class="s4">4</div>
    ...
    <img src="img/cbbmkm8c25s9i.jpg" class="bg2">
    ...
    <div class="m1">เอกสารสำหรับการเรียนรู้เพิ่มเติมในด้านช่องโหว่</div>
    <div class="mm1"><span>เอกสารอธิบายเกี่ยวกับแลป <span style="color: #A6CF98;">SQL INJECTION</span></span></div>
    ...
    <div class="m2">เอกสารสำหรับการเรียนรู้เพิ่มเติมในด้านช่องโหว่</div>
    <div class="mm2"><span>เอกสารขยายความของคำสั่งที่ใช้ภายในแลป</span></div>
