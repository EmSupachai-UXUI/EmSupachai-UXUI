    ...
    <div class="row" style="padding: 50px;">
        ...
        <div class="col-lg-8 mt-5 text-white">
            <div style="padding-left:18px;">
                ...
                <div class="mt-5">
                    <h3><b style="color: #F0A500;">Web Security</b></h3>
                </div>
                <div class="mt-3">
                ...
                <div class="mt-3">
                    ...
                    <a href="Download/file.pdf" download><button style="width: 230px;"
                            class="btn-custom-border">เอกสาร. PDF</button></a>
                </div>
            </div>
        </div>
                ...
                <div class="container mt-4">
                    <div class="row">
                        ...
                        <div class="col-lg-4 text-white mt-5">
                            <a href="?testing=3"><div class="<?php if($i == 1){echo "testlist-card";}else{echo "testlist-card-2";} ?>">
